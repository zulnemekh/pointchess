 function engineGame(options) {
    ...
    options = options || {}
    var my1_pgn = '2bqkbn1/2pppp2/np2N3/r3P1p1/p2N2B1/5Q2/PPPPKPP1/RNB2r2 w KQkq - 0 1';
    var game = new Chess(my1_pgn);
    var board;

    // var engine = new Worker('/assets/stockfosh.js');
    var stockfishengine = new Worker(options.stockfishjs || '/assets/stockfish.js');    
    var engineStatus = {};
    ...
    if(options.book) {
        ...
        bookRequest.onload = function(event) {
            if(bookRequest.status == 200) {
                stockfishengine.postMessage({book: bookRequest.response});
