...
class TrainsControllerTest < ActionController::TestCase
  ...
  test "should create train" do
    assert_difference('Train.count') do
      post :create, train: { insert_admin: @train.insert_admin, pgn_type: @train.pgn_type, text_data: @train.text_data, title: @train.title }
    end
  ...
  test "should update train" do
    patch :update, id: @train, train: { insert_admin: @train.insert_admin, pgn_type: @train.pgn_type, text_data: @train.text_data, title: @train.title }
    assert_redirected_to train_path(assigns(:train))
  end
